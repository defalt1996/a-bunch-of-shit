package com.defalt.a_bunch_of_shit.base.baseview.bottombar;
/*
 *  封装底部tab栏（包含未读消息）以便复用
 *  author: Derrick
 *  Time: 2019/6/18 9:47
 *
 */
...
public class BottomBarTab extends FrameLayout {
    ...
    public BottomBarTab(@NonNull Context context, @DrawableRes int icon, CharSequence title) {
        this(context, null, icon, title);
    }

    public BottomBarTab(@NonNull Context context, @Nullable AttributeSet attrs, @DrawableRes int icon, CharSequence title) {
